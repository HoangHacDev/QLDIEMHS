...
namespace QLDiemHocSinh.Handlers
{
    public class DiemHocSinhHandler
    {
        ...
        public void HandleInsert(TextBox maHS, TextBox maLop, ComboBox maMH, ComboBox maLoaiDiem, TextBox diem, TextBox hocKy, TextBox namHoc, Action<string> onSuccess)
        {
            ...
            string newId = _diemServices.ThemDiemHS(maHocSinh, MaLop, maMonHoc, MaLoaiDiem, DiemHS, HocKy, NamHoc);
        ...
        {
            List<DiemHocSinhModel> diemHocSinhModels = _diemServices.GetDiemHS();
            ...
            {
                dt.Rows.Add(i + 1, diemHocSinhModels[i].MaDiem, diemHocSinhModels[i].TenMH, diemHocSinhModels[i].TenLoaiDiem, diemHocSinhModels[i].HeSo, diemHocSinhModels[i].Diem);
            }
        ...
        public void HandleUpdate(string id_MaDiem, TextBox maHS, TextBox maLop, ComboBox maMH, ComboBox maLoaiDiem, TextBox diem, TextBox hocKy, TextBox namHoc, Action onSuccess)
        {
            string maHocSinh = maHS.Text.Trim();
            string MaLop = maLop.Text.Trim();
            string maMonHoc = maMH.SelectedValue?.ToString();
            ...
            bool updated = _diemServices.CapnhatDiemHS(id_MaDiem, maHocSinh, MaLop, maMonHoc, MaLoaiDiem, DiemHS, HocKy, NamHoc);
            if (updated)
            {
